...
const QUOTES_ES: Quote[] = [
  ...
  { id: "es-r6", text: "La paz interior comienza cuando eliges no permitir que otro evento controle tus emociones.",  author: "Pema Chödrön",        category: "reflection", dir: "down",  lang: "es" },
