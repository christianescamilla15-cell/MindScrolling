...
// Author names must match the authors table (English names) so author_slug
// lookups work correctly. The author detail screen shows the localized name
// from the authors table response, not from the quote's author field.
const QUOTES_ES = [
